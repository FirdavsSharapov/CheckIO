...
# need more than one day to solve them. All of these missions can be simply solved by brute force, 
...
# This mission is the first one of the series. Here you should find the length of the 
# longest substring that consists of the same letter. For example, line "aaabbcaaaa" contains four substrings 
